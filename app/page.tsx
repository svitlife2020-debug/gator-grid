    ...
    <section id="top" className="relative overflow-hidden" style={{ background: C.green, minHeight: 600 }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 flex flex-col items-center text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <a href="#volunteer" className="px-10 py-4 rounded-full text-base font-black uppercase transition-all duration-300 hover:scale-[1.03]"
          ...
          <a href="#events" className="px-10 py-4 rounded-full text-base font-black uppercase transition-all duration-300 hover:bg-white hover:text-green-900"
        ...
        <div className="rounded-3xl overflow-hidden relative"
          ...
          <div className="p-10 md:p-14 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              <p className="text-xs font-black tracking-[0.3em] uppercase mb-3" style={{ color: `${C.gold}cc` }}>A Message From</p>
